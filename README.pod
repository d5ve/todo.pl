...
With each task being on a single line. The status codes currently are:
...
=item todo.txt - Gina Trapani - L<http://todotxt.com/>
...
=item * B<t-> - Colin Wright - L<http://www.penzba.co.uk/t-/>
